...
class AssetPurchasesChart extends ChartWidget
{
    ...
    protected function getDataByDay(): array
    {
        ...
        for ($i = 23; $i >= 0; $i--) {
            ...
            $data[] = AssetPurchase::whereBetween('created_at', [$startHour, $endHour])->count();
        }
    ...
    protected function getDataByWeek(): array
    {
        ...
        for ($i = 6; $i >= 0; $i--) {
            ...
            $labels[] = $day->format('D');
            $data[] = AssetPurchase::whereDate('created_at', $day->toDateString())->count();
        }
    ...
    protected function getDataByMonth(): array
    {
        ...
        for ($i = 1; $i <= $daysInMonth; $i++) {
            ...
            $data[] = AssetPurchase::whereDate('created_at', $date->toDateString())->count();
        }
    ...
    protected function getDataByYear(): array
    {
        ...
        for ($i = 1; $i <= 12; $i++) {
            $data[] = AssetPurchase::whereYear('created_at', Carbon::now()->year)
